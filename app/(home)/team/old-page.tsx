      ...
      <main className="h-screen min-h-screen overflow-y-scroll bg-gradient-hero text-foreground md:overflow-hidden md:h-auto scroll-smooth snap-y snap-mandatory md:snap-none">
          ...
          <div className="relative z-10 max-w-md sm:max-w-[80%] mx-auto text-center space-y-8 animate-slide-up mt-20 md:mt-0">
            <div className="space-y-4 cursor-default md:pt-4">
              ...
              <p className="max-w-2xl mx-auto subtitle">
                ...
                <span className="text-foreground">Measure L&D ROI, spot future leaders, and prevent attrition</span>—without asking employees to fill out a single survey.
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-xs text-center border text-muted-foreground">
                No employee data entry required.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-8 text-center">
            ...
            <div className="mt-2">
              <h3 className="mb-2 text-xl heading sm:text-2xl">
                The <span className="text-accent">Manager-First</span> Intelligence Layer
              </h3>
              <p className="mx-auto subtitle md:max-w-2xl">
                We solved the #1 failure point of HR tech: friction. No skills inventories. No employee login required. Just pure manager insight.
              </p>
              <ul className="grid max-w-2xl gap-3 mx-auto mt-5 text-left md:grid-cols-2 text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-foreground font-semibold">Training ROI Estimates</span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-foreground font-semibold">Promotion Readiness</span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-foreground font-semibold">Attrition Risk Detection</span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-foreground font-semibold">Bench Strength Analysis</span>
          ...
          <div className="max-w-3xl mx-auto space-y-8 text-center">
            <div className="mt-2">
              <h3 className="mb-2 text-xl text-transparent heading sm:text-2xl bg-gradient-accent bg-clip-text">
                Zero Surveys. Zero Friction.
              </h3>
              <p className="mx-auto subtitle md:max-w-2xl">
              Traditional platforms fail because they demand hours of data entry from busy teams. GoCareerPath is different.
              </p>
              <ul className="grid max-w-2xl gap-3 mx-auto mt-5 text-left md:grid-cols-2 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="mt-1 text-lg">⚡</span>
                  <div>
                    <span className="text-foreground font-semibold">Manager-Only Input</span>
                    <div>
                      Assess a team of 10 in under 15 minutes. No employee onboarding required.
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 text-lg">🤖</span>
                  <div>
                    <span className="text-foreground font-semibold">AI-modeled Gaps</span>
                    <div>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-foreground font-semibold">Future-Proofing</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="mt-1 text-lg">🔄</span>
                  <div>
                    <span className="text-foreground font-semibold">Internal Mobility</span>
        ...
        <section className="px-4 py-20 sm:px-6 lg:px-8 bg-gradient-to-t from-background to-muted snap-start md:snap-none">
          <div className="mx-auto md:max-w-2xl">
            ...
            <ul className="grid max-w-2xl gap-4 mx-auto text-left md:grid-cols-2">
              <li className="p-4 transition rounded-lg bg-background/50 border border-border/50 hover:border-accent/50">
        ...
        <section className="px-4 pt-20 pb-32 sm:px-6 lg:px-8 bg-gradient-to-b from-background to-muted/20 snap-start md:snap-none">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-6 heading text-center">
              <span className="text-transparent bg-gradient-accent bg-clip-text">
            ...
            <Browser className="mx-auto lg:w-5xl bg-muted/20">
              <div className="max-w-4xl p-8 mx-auto space-y-8 bg-gradient-card rounded-2xl">
                ...
                <div>
                  <div className="grid gap-8 md:grid-cols-2">
                    <div className="py-1 space-y-3 text-sm rounded-lg text-muted-foreground">
                      <div className="flex justify-between items-center p-2 bg-background/40 rounded">
                        <span>Readiness Score:</span>
                        <span className="text-success font-bold text-lg">High (88%)</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-background/40 rounded">
                        <span>Training ROI Potential:</span>
                        <span className="text-success font-bold text-lg">4.5x</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-background/40 rounded">
                        <span>Retention Risk:</span>
                        <span className="text-warning font-bold">Medium (Market Demand)</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-background/40 rounded">
                        <span>Internal Move Savings:</span>
                        <span className="text-primary font-bold">$42,000 vs Hiring</span>
                      </div>
                    </div>

                    <div className="text-muted-foreground">
                      <div className="space-y-3 rounded-lg">
                        <h4 className="mb-1 text-accent font-semibold">
                ...
                <div>
                  <p className="px-4 mb-2 text-sm text-muted-foreground font-semibold">
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-center">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="p-6 mx-auto text-left">
                <p className="mb-4 italic text-foreground/80 text-lg">
                ...
                <p className="font-semibold">VP of People <span className="text-muted-foreground font-normal">@ Mid-Market Fintech</span></p>
              </div>
              ...
              <div className="p-6 mx-auto text-left">
                ...
                <p className="font-semibold">CTO <span className="text-muted-foreground font-normal">@ HealthTech Scale-up</span></p>
              </div>
            </div>
          </div>
        </section>
